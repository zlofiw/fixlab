...
export function SectionHeading({ tag, title, description, center = false }: SectionHeadingProps) {
  return (
    <div className={center ? 'mx-auto max-w-3xl text-center' : 'max-w-3xl'}>
      <p className="mb-3 inline-flex items-center rounded-full border border-white/80 bg-white/80 px-3 py-1 text-[11px] font-bold uppercase tracking-[0.18em] text-slate-600 shadow-[0_8px_18px_rgba(15,23,42,0.05)] backdrop-blur">
        {tag}
      </p>
