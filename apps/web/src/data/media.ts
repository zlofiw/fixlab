...
export const HERO_MEDIA: MediaAsset = {
  ...
  alt: 'Мастер ремонтирует электронику в сервисной мастерской',
...
export const WORKBENCH_MEDIA: MediaAsset = {
  ...
  alt: 'Рабочий стол ремонта электроники с инструментами и платами',
...
export const TECHNICIAN_MEDIA: MediaAsset = {
  ...
  alt: 'Мастер с измерительным прибором во время диагностики',
...
export const COMPONENT_CLOSEUP_MEDIA: MediaAsset = {
  ...
  alt: 'Крупный план микросхемы на печатной плате',
...
export const PHONE_PARTS_MEDIA: MediaAsset = {
  ...
  alt: 'Разобранные комплектующие смартфона на столе',
...
export const PHONE_REPAIR_MEDIA: MediaAsset = {
  ...
  alt: 'Ремонт смартфона отверткой крупным планом',
